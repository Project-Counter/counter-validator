...
- fix: correct COUNTER API validation endpoint path in the API documentation
- test: automatically verify API paths used in documentation examples

## [0.14.0] - 2026-08-06

- feat: add Docker support for local development and deployment (thanks to Josh Creek, https://github.com/jcreek)
- chore: update python dependencies to the latest versions
