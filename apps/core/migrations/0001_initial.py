...
class Migration(migrations.Migration):
	...
	operations = [
		...
		migrations.CreateModel(
			...
			fields=[
				...
				(
					...
					models.FileField(
						null=True,
						storage=core.classes.storage.RandomFileSystemStorage(location="upload/"),
		...
		migrations.AddConstraint(
			model_name="sushidownload",
			constraint=models.CheckConstraint(
				condition=models.Q(
					("platform__isnull", True), ("platform_name", ""), _connector="OR"
				),
				name="core_sushidownload_platform_union",
			),
		),
		migrations.AddConstraint(
			...
			constraint=models.CheckConstraint(
				...
				name="core_filevalidation_platform_union",
			),
		),
	]
